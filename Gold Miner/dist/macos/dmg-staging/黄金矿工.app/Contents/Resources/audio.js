(() => {
  ...
  function play(event, options = {}) {
    ...
    switch (event) {
      ...
      case "hook_shoot": {
        playNoise({ duration: 0.22, gain: 0.2 * v, filter: { type: "bandpass", freq: 1100, q: 0.8 }, release: 0.2 });
        playTone({ type: "sine", freq: 280, freqTo: 140, duration: 0.18, gain: 0.12 * v, detune: det, filter: { type: "lowpass", freq: 900, q: 0.7 } });
        break;
      }
      case "hook_hit_gold": {
